...
MACRO_CONFIG_INT(SvSlowDownRescue, sv_slow_down_rescue, 0, 0, 1, CFGFLAG_SERVER, "")
MACRO_CONFIG_INT(SvSlowDownRescueStart, sv_slow_down_rescue_start, 1, 0, 1000, CFGFLAG_SERVER, "")
MACRO_CONFIG_INT(SvSlowDownRescueMaximum, sv_slow_down_rescue_maximum, 3, 1, 1000, CFGFLAG_SERVER, "")
MACRO_CONFIG_INT(SvSlowDownRescueTicker, sv_slow_down_rescue_regeneration_speed, 60, 1, 1000, CFGFLAG_SERVER, "")
